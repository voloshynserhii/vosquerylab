export const gradients = {
  primary: "bg-gradient-to-r from-violet-600 via-purple-500 to-indigo-500",
  hero: "bg-[radial-gradient(circle_at_68%_35%,rgba(124,58,237,0.34),transparent_30%),linear-gradient(135deg,#050816_0%,#090d25_48%,#06091a_100%)]",
  page: "bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_40%,#f8fafc_100%)]",
